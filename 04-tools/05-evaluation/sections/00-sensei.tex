...
During the empirical experiment of Section~\ref{sec:experiment}, the mean observed remediation time of a guideline violation is 19 seconds \changed{for users of the test group and 129 s for users of the control group}.
