...
The \textit{purpose} is evaluating the usability and effectiveness \hl{of several of the features offered by Sensei during development, such as customized guidelines and quick-fixes in the \gls{ide}}.
...
\hl{In the control group the average number of violations introduced is 24.7, as shown in the bottom left of Figure~\ref{fig:hist-control-test}.
...
\hl{The mean remedation time when a quick-fix was used was 17.36 s.
