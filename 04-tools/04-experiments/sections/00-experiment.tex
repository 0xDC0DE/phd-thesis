...
The \textit{purpose} is evaluating the usability and effectiveness of \changed{several of the features offered by Sensei during development, such as customized guidelines and quick-fixes in the \gls{ide}.}
...
\changed{In the control group the average number of violations introduced is 24.7, as shown in the bottom left of Figure~\ref{fig:hist-control-test}.
...
\changed{After completion of the assignment, the test group had 0.22 remaining guidelines on average, as shown in the top right in Figure~\ref{fig:hist-control-test}.
...
Out of all the coding guideline violations \changed{in the test group}, 98.4\% have been removed eventually.
...
\changed{The mean remedation time when a quick-fix was used was 17.36 s.
...
\changed{This increase in development time is explained by the large number of coding guideline violations that are not addressed by users in the control group.
On average 8.8 violations were remaining in the control group, and the mean remediation time in this group was 129 s.
Resolving all guideline violations would on then lead to an average development time of 80.46 minutes, which is 17\% more than the test group.
