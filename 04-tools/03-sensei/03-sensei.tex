...
Some of these features are very useful at improving the context awareness of Sensei and its usability, other features fell out of use.
...
The rules include several features to improve the usability of the developer and add support for libraries and for design flaws.
}
