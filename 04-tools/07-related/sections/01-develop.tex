...
\subsection{Artificial intelligence completion}
Recently some tools have emerged to help a developer produce code more efficiently with the help of \gls{ai}.
Some examples of \gls{ai} completions tools are Copilot\footurl{https://copilot.github.com/}, tabnine\footurl{https://www.tabnine.com/} (formerly codota\footurl{https://www.codota.com/}),and  kite\footurl{https://www.kite.com/}.
...
Many developers have used Copilot and have found that it was accurate and often improved their productivity.
Generally, if a developer does not know how to complete a feature, they will often Google it.
...
When Copilot was used to complete 1,692 code scenarios with risk of introducing vulnerabilties. 
Researchers found that in 40\% of the cases the suggested code was still vulnerable~\cite{copilot2021}.
It is clear that it still requires judgement from the developer to ensure the produced code is secure.
