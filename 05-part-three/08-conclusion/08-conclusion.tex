...
First, the trained \gls{2pl} model from the field of \gls{irt} offered some useful insights in the mental model of the developer.
...
The latter two are achieved through calibrating a two parameter logistic (2PL) model from the field of \gls{irt}.
