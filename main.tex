...
%include title pages provided by dean's office
\usepackage{pdfpages}

\usepackage{00-setup/phd}

% to mark changes to the examination board
%\newcommand{\changed}[1]{\textcolor{scw-teal-darker}{#1}}
...
% Fix incorrect hyphenation
\hyphenation{dev-sec-ops}
...
\usepackage{multirow}
\usepackage{float}				% make figures, listings
...
\begin{tcolorbox}[colback=scw-sky-blue!5,colframe=scw-teal,
...
\newcommand{\graybattlecard}[7]
{
\begin{battlecardenviro}
\begin{tcolorbox}[colback=scw-ivory!5,colframe=scw-ivory,
title={#1 \hfill\circled{\thebattlecardcounter}\\
\footnotesize{#2}},
coltitle=scw-charcoal,fonttitle=\sffamily\large]
\small{#3}
...
\includepdf[pages=1-4]{01-frontmatter/titel-01002309.pdf}
...
\input{05-part-three/part-three}
